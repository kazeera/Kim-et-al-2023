...
# Read in drug list from Excel file and order lowest to highest identifier
...
# This function returns a subset of a "table" with only the rows of interest
