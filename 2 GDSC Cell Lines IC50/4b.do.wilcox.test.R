...
x <- sprintf("ssGSEA scores top%s cell lines for BC, LP", TOP_WHAT)
# NORMALITY TEST: 
...
# #Perform Wilcoxin signed rank test 
# - a non-parametric statistical hypothesis test used to compare two related samples, matched samples, 
