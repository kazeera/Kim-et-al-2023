#' Purpose: 
#' Specifically for paper, to get differences of top 5 cell lines and rotate heatmap part 2a dendogram
...
library(dendextend) # did not end up using this dendogram rotation visualization in paper
...
# Rotate dendogram - different tests to get visualization we want
